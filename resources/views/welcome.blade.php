        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/index') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">صفحه اصلی</a>
                    @else
                    ...
                    <div dir="rtl" class="grid grid-cols-1 md:grid-cols-2">
                        <div  class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">دانشکده</div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                <object data="{{asset('svg/student.svg')}}" class="w-8 h-8 text-gray-500">

                                </object><div class="ml-4 text-lg leading-7 font-semibold">دانشجو</div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                <object data="{{asset('svg/teacher.svg')}}" class="w-8 h-8 text-gray-500">

                                </object>
                                <div class="ml-4 text-lg leading-7 font-semibold">استاد</div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                <object data="{{asset('svg/project.svg')}}" class="w-8 h-8 text-gray-500">

                                </object>
                            <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">پروژه</div>
                            </div>
